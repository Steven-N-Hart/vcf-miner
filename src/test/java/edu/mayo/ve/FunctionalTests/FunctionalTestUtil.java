...
public class FunctionalTestUtil {
    ...
    public static String load(File vcf, String user, String alias, int overflowThreshold, boolean reporting) throws ProcessTerminatedException {
        ...
        parser.parse(null, vcf.getAbsolutePath(), workspaceKey, overflowThreshold, reporting, false, true);  //put true in the second to last param for verbose load reporting
        return workspaceKey;
    }
